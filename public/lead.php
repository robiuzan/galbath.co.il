<?php
/**
 * lead.php — גל אמבטיות (Gal Ambatyot) lead/quote form handler.
 *
 ...
 *
 * 🔶 Confirm the destination mailbox below EXISTS (or forwards). If service@galbath.co.il
 *    is not a real mailbox on this account, change $TO to one that is.
 */
declare(strict_types=1);
header('Content-Type: application/json; charset=utf-8');

$TO   = 'service@galbath.co.il';      // 🔶 confirm this mailbox receives/forwards
$FROM = 'noreply@galbath.co.il';      // must be on a domain hosted on this server
$SITE = 'גל אמבטיות';
